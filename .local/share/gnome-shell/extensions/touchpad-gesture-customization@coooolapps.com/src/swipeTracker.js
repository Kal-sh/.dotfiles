...
export const TouchpadSwipeGesture = GObject.registerClass({
    ...
    constructor(nfingers, allowedModes, orientation, followNaturalScroll = true, checkAllowedGesture, gestureSpeed = 1.0) {
        super();
        this._cumulativeX = 0;
        this._cumulativeY = 0;
        this.enabled = true;
    ...
    _handleEvent(_actor, event) {
        ...
        if (this._allowedModes !== Shell.ActionMode.ALL &&
    ...
    isItHoldAndSwipeGesture() {
        if (this._holdGestureCancelTime === 0)
            return false;
        return (this._holdGestureCancelTime - this._holdGestureBeginTime >=
